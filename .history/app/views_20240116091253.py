...
def index():
    ...
    # Returning template, filename, and the count of detected cars, buses, and trucks
    result = {"cars": ccnt, "buses": bcnt, "trucks": tcnt}
...
def api_detect():
    try:
        ...
        # Returning JSON response with the count of detected cars, buses, and trucks
        result = {"cars": ccnt, "buses": bcnt, "trucks": tcnt}
